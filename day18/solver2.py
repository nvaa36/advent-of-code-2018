...
def calc_lumber():
    ...
    for minute in range(mins):
        ...
        plots = new_plots
        # finds the offset between equal values. The offset is 28. Every 28
        # minutes, the field resets
        if plots in old_plots:
            print(len(old_plots) - old_plots.index(plots), minute)
        old_plots.append(plots)
